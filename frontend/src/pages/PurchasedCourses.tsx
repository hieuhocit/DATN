...
const PurchasedCourses: React.FC = () => {
  ...
  return (
    <Box mt={"128px"}>
        <CourseSection title="Khóa học đã mua" courses={coursesData} />
    </Box>
  );
};
