import { Box, Typography, List, ListItemButton, ListItemText, Divider, Drawer } from '@mui/material';
...
export default function Sidebar({ 
  ...
  const SidebarContent = (
    ...
    >
      ...
      <Typography variant="h6" fontWeight="bold" mb={2}>📚 Nội dung khóa học</Typography>

      <List>
        {lessons.map((lesson, idx) => {
          const isSelected = currentLessonId !== null && lesson.id === currentLessonId;
          const bgColor = isSelected ? (isDark ? '#333' : '#e3f2fd') : 'transparent';
            ...
            <Box key={lesson.id}>
              ...
              >
                <ListItemText
                  ...
                  secondary={`${Math.floor(lesson.duration / 60)}:${String(lesson.duration % 60).padStart(2, '0')}`}
                />
              </ListItemButton>
